...
function Modules.CommandBar:Toggle()
    ...
    suggestionsFrame.BackgroundTransparency = 0.25 
...
Modules.BypassChatFilter = {
    ...
    BypassFont = {
        ['a'] = '￯﾿ﾐ￯ﾾﾰ', ['b'] = '￯﾿ﾐ￯ﾾﾬ', ['c'] = '￯﾿ﾑ￯ﾾﾁ', ['d'] = '￯﾿ﾔ￯ﾾﾁ', ['e'] = '￯﾿ﾐ￯ﾾﾵ',
        ['f'] = 'f', ['g'] = '￯﾿ﾉ￯ﾾﾡ', ['h'] = '￯﾿ﾒ￯ﾾﾻ', ['i'] = '￯﾿ﾑ￯ﾾﾖ', ['j'] = '￯﾿ﾑ￯ﾾﾘ',
        ['k'] = 'k', ['l'] = 'l', ['m'] = 'm', ['n'] = 'n', ['o'] = '￯﾿ﾐ￯ﾾﾾ',
        ['p'] = '￯﾿ﾑ￯ﾾﾀ', ['q'] = '￯﾿ﾔ￯ﾾﾛ', ['r'] = '￯﾿ﾐ￯ﾾﾳ', ['s'] = '￯﾿ﾑ￯ﾾﾕ', ['t'] = 't',
        ['u'] = 'u', ['v'] = 'v', ['w'] = 'w', ['x'] = '￯﾿ﾑ￯ﾾﾅ', ['y'] = '￯﾿ﾑ￯ﾾﾃ',
        ['z'] = 'z',
        ['A'] = '￯﾿ﾐ￯ﾾﾐ', ['B'] = '￯﾿ﾐ￯ﾾﾒ', ['C'] = '￯﾿ﾐ￯ﾾﾡ', ['D'] = '￯﾿ﾄ￯ﾾﾎ', ['E'] = '￯﾿ﾐ￯ﾾﾕ',
        ['F'] = 'F', ['G'] = 'G', ['H'] = '￯﾿ﾐ￯ﾾﾝ', ['I'] = '￯﾿ﾐ￯ﾾﾆ', ['J'] = '￯﾿ﾐ￯ﾾﾈ',
        ['K'] = 'K', ['L'] = 'L', ['M'] = '￯﾿ﾐ￯ﾾﾜ', ['N'] = 'N', ['O'] = '￯﾿ﾐ￯ﾾﾞ',
        ['P'] = '￯﾿ﾐ￯ﾾﾠ', ['Q'] = '￯﾿ﾔ￯ﾾﾚ', ['R'] = 'R', ['S'] = '￯﾿ﾐ￯ﾾﾅ', ['T'] = '￯﾿ﾐ￯ﾾﾢ',
        ['U'] = 'U', ['V'] = 'V', ['W'] = 'W', ['X'] = '￯﾿ﾐ￯ﾾﾥ', ['Y'] = '￯﾿ﾐ￯ﾾﾣ',
        ['Z'] = 'Z'
    }
}
...
function Modules.AutoAttack:Enable()
    ...
    print("￢ﾜﾅ Auto-Attack: [Enabled] | Delay: " .. self.State.ClickDelay * 1000 .. "ms")
end
...
RegisterCommand({
    ...
    if newDelay and newDelay > 0 then
        ...
        if Modules.AutoAttack.State.Enabled then
            print("￢ﾜﾅ Auto-Attack: [Enabled] | Delay: " .. newDelay .. "ms")
        end
        return 
    end
...
--======================================================================================
-- MODULE: EditStats (v2 with Anti-Revert)
-- PURPOSE: Provides a UI to edit Humanoid properties and includes a "Lock" feature
--          to continuously re-apply the value, bypassing server-side stat reverts.
--======================================================================================
...
Modules.EditStats = {
    State = {
        UI = nil,
        -- This table will store the values we are actively forcing.
        -- Example: { WalkSpeed = 200, JumpPower = 100 }
        ActiveOverrides = {},
        -- This will hold the connection to our main loop, so we can manage it.
        HeartbeatConnection = nil
    }
}

--- The core bypass function. It runs every frame and forces the locked properties.
function Modules.EditStats:ForceProperties()
    -- Stop the loop if there are no active overrides to save performance.
    ...
    -- Iterate through the properties we want to lock.
    for propName, desiredValue in pairs(self.State.ActiveOverrides) do
        -- Micro-optimization: Only write the value if the server has changed it.
        if humanoid[propName] ~= desiredValue then
            humanoid[propName] = desiredValue
        end
    end
end
...
function Modules.EditStats:CreateUI()
    ...
    mainFrame.Size = UDim2.new(0, 300, 0, 300) -- Increased width for the new button
    ...
    propertyList.CanvasSize = UDim2.new(0, 0, 2, 0)
    ...
    local function populateProperties()
        ...
        for _, child in ipairs(propertyList:GetChildren()) do if child:IsA("Frame") then child:Destroy() end end
        ...
        for i, propName in ipairs(propertiesToEdit) do
            ...
            nameLabel.Size = UDim2.new(0.4, 0, 1, 0) -- Adjusted size
            ...
            valueBox.Size = UDim2.new(0.4, 0, 1, 0) -- Adjusted size
            ...
            -- [NEW] The Lock Button (acting as a checkbox)
            ...
            lockButton.MouseButton1Click:Connect(function()
                ...
                -- Check if this property is already being overridden
                if Modules.EditStats.State.ActiveOverrides[propName] then
                    -- If yes, unlock it
                    Modules.EditStats.State.ActiveOverrides[propName] = nil
                    lockButton.BackgroundColor3 = Color3.fromRGB(80, 20, 20)
                    lockButton.Text = "Lock"
                else
                    -- If no, lock it
                    Modules.EditStats.State.ActiveOverrides[propName] = newValue
                    lockButton.BackgroundColor3 = Color3.fromRGB(20, 80, 20)
                    lockButton.Text = "Locked"
                    
                    -- If the main loop isn't running, start it.
            ...
            valueBox.FocusLost:Connect(function(enterPressed)
                if enterPressed then
                    ...
                    if newValue and currentHumanoid then
                        currentHumanoid[propName] = newValue -- Set it once
                        
                        -- [UPDATE] If this property is locked, update the locked value too.
                        if Modules.EditStats.State.ActiveOverrides[propName] then
                            Modules.EditStats.State.ActiveOverrides[propName] = newValue
                        end
...
RegisterCommand({
    ...
    Description = "Opens a properties window to edit and lock your character's Humanoid stats."
}, function(args)
...
function Modules.AdvancedReach:Enable()
    ...
    print("￢ﾜﾅ Advanced Reach: [Enabled] | Distance: " .. self.State.ReachDistance .. " studs")
end
...
function Modules.AdvancedReach:Disable()
    ...
    print("￢ﾚﾪ Advanced Reach: [Disabled]")
end
...
RegisterCommand({
    ...
    if newDistance and newDistance > 0 then
        ...
        if Modules.AdvancedReach.State.Enabled then
            print("￢ﾜﾅ Advanced Reach: [Enabled] | Distance: " .. newDistance .. " studs")
        end
        return 
    end
...
RegisterCommand({
    ...
    if success then
        Modules.RemoteBypass.State.IsActive = true
        print("￢ﾜﾅ Remote Bypass Initialized (v2). Your scripts can now use the safe functions.")
        print("   -> Usage: _G.SafeFireServer(RemoteEvent, ...)")
        print("   -> Usage: _G.SafeInvokeServer(RemoteFunction, ...)")
    else
        print("￢ﾝﾌ Remote Bypass Failed: " .. tostring(err))
    end
end)
...
Modules.BypassChatFilter = {
    ...
    BypassFont = {
        ['a'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾰ', ['b'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾬ', ['c'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾁ', ['d'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾔ￯﾿ﾯ￯ﾾﾾ￯ﾾﾁ', ['e'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾵ',
        ['f'] = 'f', ['g'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾉ￯﾿ﾯ￯ﾾﾾ￯ﾾﾡ', ['h'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾒ￯﾿ﾯ￯ﾾﾾ￯ﾾﾻ', ['i'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾖ', ['j'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾘ',
        ['k'] = 'k', ['l'] = 'l', ['m'] = 'm', ['n'] = 'n', ['o'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾾ',
        ['p'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾀ', ['q'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾔ￯﾿ﾯ￯ﾾﾾ￯ﾾﾛ', ['r'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾳ', ['s'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾕ', ['t'] = 't',
        ['u'] = 'u', ['v'] = 'v', ['w'] = 'w', ['x'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾅ', ['y'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾑ￯﾿ﾯ￯ﾾﾾ￯ﾾﾃ',
        ['z'] = 'z',
        ['A'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾐ', ['B'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾒ', ['C'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾡ', ['D'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾄ￯﾿ﾯ￯ﾾﾾ￯ﾾﾎ', ['E'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾕ',
        ['F'] = 'F', ['G'] = 'G', ['H'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾝ', ['I'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾆ', ['J'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾈ',
        ['K'] = 'K', ['L'] = 'L', ['M'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾜ', ['N'] = 'N', ['O'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾞ',
        ['P'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾠ', ['Q'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾔ￯﾿ﾯ￯ﾾﾾ￯ﾾﾚ', ['R'] = 'R', ['S'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾅ', ['T'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾢ',
        ['U'] = 'U', ['V'] = 'V', ['W'] = 'W', ['X'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾥ', ['Y'] = '￯﾿ﾯ￯ﾾ﾿￯ﾾﾐ￯﾿ﾯ￯ﾾﾾ￯ﾾﾣ',
        ['Z'] = 'Z'
    }
}
...
function Modules.AutoAttack:Enable()
    ...
    print("￯﾿ﾢ￯ﾾﾜ￯ﾾﾅ Auto-Attack: [Enabled] | Delay: " .. self.State.ClickDelay * 1000 .. "ms")
end
...
function Modules.AutoAttack:Disable()
    ...
    print("￯﾿ﾢ￯ﾾﾚ￯ﾾﾪ Auto-Attack: [Disabled]")
end
...
RegisterCommand({
    ...
    if newDelay and newDelay > 0 then
        ...
        if Modules.AutoAttack.State.Enabled then
            print("￯﾿ﾢ￯ﾾﾜ￯ﾾﾅ Auto-Attack: [Enabled] | Delay: " .. newDelay .. "ms")
        end
        return 
    end
...
function Modules.AntiRagdoll:Disable()
    ...
    print("￢ﾚﾪ Anti-Ragdoll: [Disabled]")
end
...
RegisterCommand({
    ...
    if Modules.AntiRubberband.State.Enabled then
        print("￢ﾜﾅ Anti-Rubberband: [Enabled]")
        -- Connect our validation function to RunService.Stepped, which runs every frame.
        Modules.AntiRubberband.State.Connection = RunService.Stepped:Connect(function()
            Modules.AntiRubberband:ValidateCFrame()
        end)
    else
        print("￢ﾚﾪ Anti-Rubberband: [Disabled]")
        -- If the connection exists, disconnect it to stop the loop and save performance.
        if Modules.AntiRubberband.State.Connection then
            Modules.AntiRubberband.State.Connection:Disconnect()
            Modules.AntiRubberband.State.Connection = nil
...
function Modules.AdvancedReach:Enable()
    ...
    print("￯﾿ﾢ￯ﾾﾜ￯ﾾﾅ Advanced Reach: [Enabled] | Distance: " .. self.State.ReachDistance .. " studs")
end
...
function Modules.AdvancedReach:Disable()
    ...
    print("￯﾿ﾢ￯ﾾﾚ￯ﾾﾪ Advanced Reach: [Disabled]")
end
...
RegisterCommand({
    ...
    if newDistance and newDistance > 0 then
        ...
        if Modules.AdvancedReach.State.Enabled then
            print("￯﾿ﾢ￯ﾾﾜ￯ﾾﾅ Advanced Reach: [Enabled] | Distance: " .. newDistance .. " studs")
        end
        return 
    end
